...
const (
	PingPongService_Sending_FullMethodName = "/pingpong.PingPongService/Sending"
)
...
type PingPongServiceClient interface {
	Sending(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PongResponse, error)
}
...
func (c *pingPongServiceClient) Sending(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PongResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PongResponse)
	err := c.cc.Invoke(ctx, PingPongService_Sending_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PingPongServiceServer interface {
	Sending(context.Context, *PingRequest) (*PongResponse, error)
...
func (UnimplementedPingPongServiceServer) Sending(context.Context, *PingRequest) (*PongResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Sending not implemented")
}
...
func _PingPongService_Sending_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PingPongServiceServer).Sending(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PingPongService_Sending_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingPongServiceServer).Sending(ctx, req.(*PingRequest))
	}
...
var PingPongService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Sending",
			Handler:    _PingPongService_Sending_Handler,
		},
	},
